...
const Visa = () => {
  ...
  <div>
    ...
    <p className="ml-[20px] lg:ml-[30px] mt-[30px] text-[14px] md:text-[15px] pr-[20px]">
      Escape to your dream destination with Tranquilane Travels’ exclusive vacation packages! Whether
      <br className="hidden lg:block" />
      you’re craving a relaxing beach retreat, an exciting adventure, or a cultural exploration, we curate the
      <br className="hidden lg:block" />
