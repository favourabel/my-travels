       ...
       <Navbar/>
         ...
         <div style={{
                 ...
                 <motion.p
                   ...
                   className='text-center pt-[10%] text-[50px] text-orange-400 font-bold'
                 >
                    Visa Procurement
                 </motion.p>
                 ...
                 <motion.p
                   ...
                   className='text-center pt-[30px] text-[20px] pb-[10%] text-orange-400 font-bold'
                 >
                   Home/Visa Procurement
                 </motion.p>
               </div>
                      ...
                      <div className='flex gap-[120px]'>
                            ...
                            <img src={stamp} className='w-[730px] rounded-[8px] mt-[60px] ml-[70px]'/>
                    
                              <p className='ml-[30px] font-bold text-[40px] mt-[20px] text-purple-700'>Visa Procurements</p>
                                ...
                                Experience the world your way with Macwise Travels Customized Tours! Whether you seek<br/>
                                 ...
                                 seamless and unforgettable travel experience.</p>
                                  ...
                                  Escape to your dream destination with Tranquilane Travels’ exclusive vacation packages! Whether<br/>
                                  you’re craving a relaxing beach retreat, an exciting adventure, or a cultural exploration, we curate the<br/>
