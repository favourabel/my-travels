...
const About = () => {
  ...
  className="py-[60px] mt-[40px] mb-[60px]"
>
  ...
  <motion.p
    ...
    className="text-center mt-[10%] font-bold text-[60px] text-white"
  >
    About Us
  </motion.p>
  ...
  <motion.p
    ...
    className="text-center pt-[20px] text-[20px] text-white"
  >
    Home / About Us
  </motion.p>
  ...
  >
    ...
    <img
      src={agent}
      className="w-full lg:w-[900px] rounded-[8px] mt-[30px] lg:mt-[60px]"
    />
  ...
  <motion.div
    ...
    viewport={{ once: false, amount: 0.3 }}
    transition={{ duration: 0.8 }}
    className="w-full mt-[30px] lg:mt-[60px]"
  >
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 py-[80px]">
    ...
    <motion.div
      ...
      className="bg-[#f4f4f4] border border-gray-300 rounded-[12px] p-[40px] min-h-[260px]"
    >
